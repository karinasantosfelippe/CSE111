...
def assyngment_example_2():
    ...
    with open("source/hymns.csv", "rt") as csv_file:
...
def assyngment_example_3():
    ...
    with open("source/dentists.csv", "rt") as dentists_file:
...
def assyngment_example_4():
    ...
    dentists_list = read_compound_list("source/dentists.csv")
...
def assyngment_example_5():
    ...
    dentists_dict = read_dictionary("source/dentists.csv", PHONE_INDEX)
...
def main():
    ...
    text_list = read_list("source/plants.txt")
    # Print the entire list.
    print(text_list)
